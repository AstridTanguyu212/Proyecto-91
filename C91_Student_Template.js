...
function car1_down(){
	if(car1_y <=500){
		car1_y = car1_y + 10;
		console.log("Cuando se presione la fecha de abajo, x = " + car1_x + " | y = " + car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_right(){
	if(car1_x <= 700){
		car1_x = car1_x + 10;
		console.log("Cuando se presione la fecha derecha, x = " + car1_x + " | y = " + car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_up(){
	if(car2_y >=0){
		car2_y = car2_y - 10;
		console.log("Cuando se presione la tecla 'W', x = " + car2_x + " | y = " + car2_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_down(){
	if(car2_y <=500){
		car2_y = car2_y + 10;
		console.log("Cuando se presione la tecla 'S', x = " + car2_x + " | y = " + car2_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_left(){
	if(car2_x >=0){
		car2_x = car2_x - 10;
		console.log("Cuando se presione la tecla 'A', x = " + car2_x + " | y = " + car2_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_right(){
	if(car2_x <= 700){
		car2_x = car2_x + 10;
		console.log("Cuando se presione la tecla 'D', x = " + car2_x + " | y = " + car2_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
